...
class ToyFragment : Fragment(), SearchableFragment {

    private lateinit var recyclerView: RecyclerView
    private lateinit var recycleViewItemAdapter: RecycleViewItemAdapter
    private var itemList: List<Items_Data> = ItemRepository.toyItems // Sample toy items
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_toy, container, false)
